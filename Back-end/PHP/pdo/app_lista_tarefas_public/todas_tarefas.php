...
<head>
    ...
    <script>
        function editar(id, texto) {
            ...
            form.action = 'tarefa_controller.php?pag=todas_tarefas&acao=atualizar'
            form.method = 'POST';
            form.className = 'row'
        ...
        function deletar(id) {
            window.location = 'tarefa_controller.php?pag=todas_tarefas&acao=deletar&id='+id;
        }

        function realizar(id) {
            window.location = 'tarefa_controller.php?pag=todas_tarefas&acao=realizar&id='+id;
        }
    </script>
</head>
    ...
    <div class="container app">
        <div class="row">
            <div class="col-sm-3 menu">
                <ul class="list-group">
                    <a href="index.php">
                        <li class="list-group-item text-dark">Tarefas pendentes</li>
                    </a>
                    <a href="nova_tarefa.php">
                        <li class="list-group-item text-dark">Nova tarefa</li>
                    </a>
                    <a href="#">
                        <li class="list-group-item active text-dark">Todas tarefas</li>
                    </a>
                </ul>
            </div>
                            ...
                            <?php foreach ($tarefas as $tarefa_item) { ?>
                                ...
                                <div class="row mb-3 d-flex align-items-center tarefa">
                                    ...
                                    <div class="col-sm-9" id="tarefa-<?= $tarefa_item['id'] ?>">
                                        <?= htmlspecialchars($tarefa_item['tarefa']) . ' [' . ucfirst($tarefa_item['status']) . ']' ?>
                                    </div>
